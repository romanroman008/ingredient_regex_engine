...
def noun_requests():
    return [
        InflectionRequest(number, case) for number in GrammaticalNumber for case in GrammaticalCase
    ]
...
def test_inflect_noun_all_variants(
    word_key, inflection_request, expected_surface, generate_variations
):
    # Arrange
...
def test_inflect_adjective__happy_path(
    adjective_key, inflection_request, expected_surface, generate_variations
):
    # Arrange
...
def test_inflect_passive_adjectival_participle__happy_path(
    ppas_key, inflection_request, expected_surface, generate_variations
):
    # Arrange
